...
var _EmailTemplatesStateService = class _EmailTemplatesStateService extends AsyncHandler {
  ...
  async saveTemplate(template, old_zone = "") {
    ...
    if (template.id && old_zone) {
      const old_metadata = await lastValueFrom(fu(old_zone, "email_templates"));
      if (old_metadata.details instanceof Array) {
        await lastValueFrom(hu(old_zone, {
    ...
    const metadata = await lastValueFrom(fu(template.zone_id, "email_templates"));
    ...
    await lastValueFrom(hu(template.zone_id, {
      name: `email_templates`,
...
//# sourceMappingURL=email-templates.module-WPYLQZGI.js.map
