...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignageDisplayModalComponent, { className: "SignageDisplayModalComponent", filePath: "apps/concierge/src/app/signage/signage-display-modal.component.ts", lineNumber: 99 });
})();
...
var _SignageMediaModalComponent = class _SignageMediaModalComponent {
  ...
  async saveMedia() {
    ...
    if (this.item.id) {
      await lastValueFrom(Yc(this.item.id, new_media)).catch(onError);
    } else {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignageMediaModalComponent, { className: "SignageMediaModalComponent", filePath: "apps/concierge/src/app/signage/signage-media-modal.component.ts", lineNumber: 208 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignageMediaPreviewModalComponent, { className: "SignageMediaPreviewModalComponent", filePath: "apps/concierge/src/app/signage/signage-media-preview-modal.component.ts", lineNumber: 82 });
})();
...
function SignagePlaylistModalComponent_Conditional_112_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(6);
    \u0275\u0275property("ngModel", ctx_r0.form.value.play_at)("ngModelOptions", \u0275\u0275pureFunction0(11, _c1));
    \u0275\u0275advance(2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignagePlaylistModalComponent, { className: "SignagePlaylistModalComponent", filePath: "apps/concierge/src/app/signage/signage-playlist-modal.component.ts", lineNumber: 355 });
})();
...
var _SignageStateService = class _SignageStateService extends AsyncHandler {
  constructor() {
    ...
    this.media = combineLatest([
      ...
      this._change
    ]).pipe(filter(([_]) => !!_?.id), debounceTime(300), switchMap(() => Vc({ limit: 2500 })), map((_) => _.data.sort((a, b) => b.created_at - a.created_at)), shareReplay(1));
    ...
    this.displays = combineLatest([
      ...
      this._org.active_building,
      this._change
    ]).pipe(filter(([, bld]) => !!bld?.id), switchMap(([region, bld]) => oc({
  ...
  editMedia(media = new Wo({}), file, playlist_id = "") {
  ...
  async removeDisplay(display) {
    ...
    if (display.map_id || display.email || display.module_list.length > 0) {
      await lastValueFrom(cc(display.id, {
        signage: false
      }));
    } else {
      await lastValueFrom(lc(display.id));
    }
    this._change.next(Date.now());
  ...
  async savePlaylist(playlist) {
    const call = lastValueFrom(playlist.id ? Xc(playlist.id, playlist, "put") : ea(playlist));
  ...
  previewFileMedia(media, playlist_id = "") {
    ...
    ref.componentInstance.save.subscribe(async () => {
      ...
      if (playlist_id && new_media.id) {
        const media_list = await lastValueFrom(na(playlist_id));
        const new_media_list = [...media_list.items, new_media.id];
        await lastValueFrom(oa(playlist_id, new_media_list));
      }
      ref.close();
    });
  }
  async addMediaFromLink(url, media_item = new Wo({})) {
    const url_obj = new URL(url);
    const data = __spreadValues({}, new Wo(__spreadProps(__spreadValues({}, media_item), {
    ...
    const result = await lastValueFrom(Jc(data));
    this._active_upload.next(null);
    this._change.next(Date.now());
    notifySuccess("Successfully added media from link");
    return result;
  }
  async addMedia(file, media_item = new Wo({})) {
  ...
  async updateMedia(item) {
    if (!item?.id)
      return;
    await lastValueFrom(Yc(item.id, item));
  }
...
function SignageApprovePlaylistModalComponent_Conditional_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const current_media_r8 = (media_r6 == null ? null : media_r6[0]) || \u0275\u0275pureFunction0(25, _c04);
    \u0275\u0275advance(10);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(11, 9, (current_version_r7 == null ? null : current_version_r7.updated_at) * 1e3, "dd MMM, HH:mm"), " ");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind3(15, 12, "COMMON.ITEM_COUNT", \u0275\u0275pureFunction1(26, _c12, current_version_r7 == null ? null : current_version_r7.items.length), current_version_r7 == null ? null : current_version_r7.items.length), " ");
    \u0275\u0275advance(2);
    \u0275\u0275repeater(current_media_r8);
    const previous_version_r9 = versions_r5 == null ? null : versions_r5[1];
    const previous_media_r10 = (media_r6 == null ? null : media_r6[1]) || \u0275\u0275pureFunction0(28, _c04);
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(24, 16, (previous_version_r9 == null ? null : previous_version_r9.updated_at) * 1e3, "dd MMM, HH:mm"), " ");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind3(28, 19, "COMMON.ITEM_COUNT", \u0275\u0275pureFunction1(29, _c12, previous_version_r9 == null ? null : previous_version_r9.items.length), previous_version_r9 == null ? null : previous_version_r9.items.length), " ");
    \u0275\u0275advance(2);
...
var _SignageApprovePlaylistModalComponent = class _SignageApprovePlaylistModalComponent {
  constructor() {
    ...
    this.loading = signal("");
    this.playlist_versions = this._playlist_id.pipe(filter((_) => !!_), tap(() => this.loading.set("Loading versions...")), switchMap((id) => ra(id, { limit: 2 })), shareReplay(1));
  ...
  async undoChanges() {
    ...
    await lastValueFrom(oa(this._playlist.id, previous.items));
    this.loading.set("");
    this._dialog_ref.disableClose = false;
  ...
  async approve() {
    ...
    this._dialog_ref.disableClose = true;
    await lastValueFrom(ia(this._playlist.id));
    this.loading.set("");
    this._dialog_ref.disableClose = false;
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignageApprovePlaylistModalComponent, { className: "SignageApprovePlaylistModalComponent", filePath: "apps/concierge/src/app/signage/signage-approve-playlist-modal.component.ts", lineNumber: 156 });
})();
...
var _ZoneSelectModalComponent = class _ZoneSelectModalComponent {
  constructor() {
    ...
    this.zones = this.search_term.pipe(debounceTime(300), switchMap((term) => Nc(__spreadProps(__spreadValues({}, this.query), { q: term, limit: 100 })).pipe(map((_) => _.data), catchError(() => of([])))), map((zones) => zones.filter((zone) => !this.ignore.includes(zone.id))), startWith([]), shareReplay(1));
  }
};
...
function SignageItemPlaylistsComponent_Conditional_6_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(11, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(12, SignageItemPlaylistsComponent_Conditional_6_For_2_Conditional_12_Template, 4, 3, "div", 14);
    \u0275\u0275elementStart(13, "button", 15)(14, "icon");
    \u0275\u0275text(15, "more_vert");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(16, "mat-menu", null, 0)(18, "a", 16)(19, "div", 17)(20, "icon", 18);
    ...
    \u0275\u0275elementStart(26, "div", 17)(27, "icon", 21);
    \u0275\u0275text(28, " delete ");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(11, 11, "APP.CONCIERGE.SIGNAGE_MEDIA_COUNT", \u0275\u0275pureFunction1(18, _c13, ctx_r0.playlistCount(item_r4.id))), " ");
    \u0275\u0275advance(2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignageItemPlaylistsComponent, { className: "SignageItemPlaylistsComponent", filePath: "apps/concierge/src/app/signage/signage-item-playlists.component.ts", lineNumber: 170 });
})();
...
function SignageDisplaysComponent_Conditional_8_For_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(10, _c06))("queryParams", \u0275\u0275pureFunction1(11, _c14, display_r2.id));
    \u0275\u0275advance();
...
function SignageDisplaysComponent_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 7);
    \u0275\u0275repeaterCreate(1, SignageDisplaysComponent_Conditional_8_For_2_Template, 4, 13, null, null, _forTrack03);
    \u0275\u0275pipe(3, "async");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
var _SignageDisplaysComponent = class _SignageDisplaysComponent extends AsyncHandler {
  constructor() {
    ...
    this.triggers = this.selected.pipe(switchMap((id) => bc(id)), map((_) => _.data), tap((_) => setTimeout(() => this.switching = false, 200)), shareReplay(1));
  ...
  async setOrientation(orientation) {
    ...
    if (!display)
      return;
    await lastValueFrom(cc(display.id, { orientation, version: display.version }, "patch")).catch((e) => {
...
function SignageMediaListComponent_Conditional_18_For_3_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 18);
  }
}
function SignageMediaListComponent_Conditional_18_For_3_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 19);
  }
}
function SignageMediaListComponent_Conditional_18_For_3_div_3_Template(rf, ctx) {
  if (rf & 1) {
...
function SignageMediaListComponent_Conditional_18_For_3_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "img", 22);
  }
  if (rf & 2) {
...
function SignageMediaListComponent_Conditional_18_For_3_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
...
function SignageMediaListComponent_Conditional_18_For_3_Conditional_22_Template(rf, ctx) {
  if (rf & 1) {
...
function SignageMediaListComponent_Conditional_18_For_3_For_25_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 32);
    \u0275\u0275listener("click", function SignageMediaListComponent_Conditional_18_For_3_For_25_Template_button_click_0_listener() {
...
function SignageMediaListComponent_Conditional_18_For_3_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 17);
    \u0275\u0275conditionalCreate(1, SignageMediaListComponent_Conditional_18_For_3_Conditional_1_Template, 1, 0, "div", 18)(2, SignageMediaListComponent_Conditional_18_For_3_Conditional_2_Template, 1, 0, "div", 19);
    \u0275\u0275template(3, SignageMediaListComponent_Conditional_18_For_3_div_3_Template, 3, 0, "div", 20);
    \u0275\u0275elementStart(4, "div", 21);
    \u0275\u0275conditionalCreate(5, SignageMediaListComponent_Conditional_18_For_3_Conditional_5_Template, 1, 1, "img", 22);
    \u0275\u0275elementStart(6, "div", 23);
    \u0275\u0275text(7);
    \u0275\u0275pipe(8, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(9, SignageMediaListComponent_Conditional_18_For_3_Conditional_9_Template, 3, 3, "div", 24);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function SignageMediaListComponent_Conditional_18_For_3_Template_mat_form_field_click_19_listener($event) {
      \u0275\u0275restoreView(_r5);
      return \u0275\u0275resetView($event.stopPropagation());
    });
    \u0275\u0275elementStart(20, "input", 6);
    \u0275\u0275pipe(21, "translate");
    \u0275\u0275listener("ngModelChange", function SignageMediaListComponent_Conditional_18_For_3_Template_input_ngModelChange_20_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.playlist_search.next($event));
    });
    \u0275\u0275elementEnd()()();
    \u0275\u0275conditionalCreate(22, SignageMediaListComponent_Conditional_18_For_3_Conditional_22_Template, 3, 4, "button", 30);
    \u0275\u0275pipe(23, "async");
    \u0275\u0275repeaterCreate(24, SignageMediaListComponent_Conditional_18_For_3_For_25_Template, 4, 1, "button", 31, _forTrack04);
    \u0275\u0275pipe(26, "async");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(27, "mat-menu", null, 2)(29, "button", 32);
    \u0275\u0275listener("click", function SignageMediaListComponent_Conditional_18_For_3_Template_button_click_29_listener() {
      const media_r6 = \u0275\u0275restoreView(_r5).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.editItem(media_r6));
    });
    \u0275\u0275elementStart(30, "div", 33)(31, "icon", 34);
    \u0275\u0275text(32, "edit");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(35, "translate");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(36, "button", 36)(37, "div", 33)(38, "icon", 34);
    \u0275\u0275text(39, "add");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function SignageMediaListComponent_Conditional_18_For_3_Template_button_click_43_listener() {
      const media_r6 = \u0275\u0275restoreView(_r5).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.previewItem(media_r6));
    });
    \u0275\u0275elementStart(44, "div", 33)(45, "icon", 34);
    ...
    \u0275\u0275listener("click", function SignageMediaListComponent_Conditional_18_For_3_Template_button_click_50_listener() {
      const media_r6 = \u0275\u0275restoreView(_r5).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.removeItem(media_r6));
    });
    \u0275\u0275elementStart(51, "div", 33)(52, "icon", 37);
    \u0275\u0275text(53, " delete ");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(7);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(21, 29, "COMMON.SEARCH"))("ngModel", ctx_r2.playlist_search.getValue());
    \u0275\u0275advance(2);
    \u0275\u0275conditional(!(((tmp_29_0 = \u0275\u0275pipeBind1(23, 31, ctx_r2.playlists)) == null ? null : tmp_29_0.length) > 0) ? 22 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275repeater(\u0275\u0275pipeBind1(26, 33, ctx_r2.playlists));
    \u0275\u0275advance(10);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(35, 35, "APP.CONCIERGE.SIGNAGE_MEDIA_EDIT"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("matMenuTriggerFor", playlist_menu_r9);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(42, 37, "APP.CONCIERGE.SIGNAGE_MEDIA_ADD_PLAYLIST"), " ");
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(49, 39, "APP.CONCIERGE.SIGNAGE_MEDIA_PREVIEW"), " ");
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(56, 41, "APP.CONCIERGE.SIGNAGE_MEDIA_REMOVE"), " ");
  }
}
function SignageMediaListComponent_Conditional_18_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(2, SignageMediaListComponent_Conditional_18_For_3_Template, 57, 43, "div", 17, _forTrack04);
    \u0275\u0275pipe(4, "async");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
var _SignageMediaListComponent = class _SignageMediaListComponent {
  ...
  async addToPlaylist(media_id, playlist) {
    const media_list = await lastValueFrom(na(playlist.id));
...
_SignageMediaListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignageMediaListComponent, selectors: [["signage-media-list"]], inputs: { playlist_count: [1, "playlist_count"] }, standalone: false, features: [\u0275\u0275NgOnChangesFeature], decls: 21, vars: 17, consts: [["add_link_template", ""], ["playlist_menu", "matMenu"], ["menu", "matMenu"], [1, "relative", "p-4"], [1, "mb-4", "text-center", "text-xl", "font-medium"], ["appearance", "outline", 1, "no-subscript", "w-full"], ["matInput", "", 3, "ngModelChange", "placeholder", "ngModel"], ["icon", "", "matRipple", "", "customTooltip", "", "matTooltipPosition", "left", 1, "absolute", "right-14", "top-2", "border", "border-base-300", 3, "content", "matTooltip"], ["icon", "", "matRipple", "", "matTooltipPosition", "left", 1, "absolute", "right-2", "top-2", "border", "border-base-300", 3, "matTooltip"], ["type", "file", 1, "absolute", "inset-0", "opacity-0", 3, "change"], ["cdkDropList", "", "id", "media-list", 1, "grid", "w-full", "gap-4", "p-4", "md:grid-cols-2", "lg:grid-cols-3", 3, "cdkDropListData", "cdkDropListConnectedTo"], [1, "mx-auto", "flex", "flex-1", "flex-col", "items-center", "justify-center", "space-y-2", "p-8", "opacity-30"], [1, "my-2", "flex", "w-[20rem]", "flex-col", "space-y-4", "rounded-lg", "border", "border-base-300", "bg-base-100", "p-4", "shadow"], ["appearance", "outline", 1, "no-subscript"], ["btn", "", "matRipple", "", 1, "w-full", 3, "click"], [1, "mr-2", "text-2xl"], ["cdkDropList", "", "id", "media-list", 1, "grid", "w-full", "gap-4", "p-4", "md:grid-cols-2", "lg:grid-cols-3", 3, "cdkDropListDropped", "cdkDropListData", "cdkDropListConnectedTo"], ["cdkDrag", "", 1, "relative", "flex", "flex-col", "items-center", "justify-center", "rounded-lg", "border", "border-base-300", "bg-base-100", "p-3", "hover:opacity-80"], [1, "absolute", "inset-0", "z-0", "rounded-lg", "bg-warning", "opacity-10"], [1, "absolute", "inset-0", "z-0", "rounded-lg", "bg-error", "opacity-10"], ["class", "flex min-h-10 min-w-10 items-center justify-center rounded-2xl border-4 border-dashed border-base-400 bg-base-300", 4, "cdkDragPlaceholder"], ["preview", "", 1, "relative", "h-36", "w-full", "overflow-hidden", "rounded-lg", "bg-base-200"], ["auth", "", 1, "h-full", "w-full", "rounded-lg", "object-contain", 3, "source"], [1, "absolute", "left-1", "top-1", "rounded-lg", "px-2", "py-1", "font-mono", "text-xs", "capitalize"], [1, "absolute", "bottom-1", "right-1", "rounded-lg", "bg-info", "px-2", "py-1", "font-mono", "text-xs", "capitalize", "text-info-content"], [1, "relative", "top-1", "flex", "w-full", "items-center", "justify-between"], [1, "w-1/2", "flex-1", "truncate", "text-base-content", 3, "matTooltip"], ["icon", "", "matRipple", "", "aria-label", "Media Actions", 3, "matMenuTriggerFor"], [1, "px-2"], ["appearance", "outline", 1, "no-subscript", "w-full", 3, "click"], ["mat-menu-item", "", 3, "disabled"], ["mat-menu-item", ""], ["mat-menu-item", "", 3, "click"], [1, "flex", "items-center", "space-x-2"], [1, "text-2xl"], [1, "pr-2"], ["mat-menu-item", "", 3, "matMenuTriggerFor"], [1, "text-2xl", "text-error"], [1, "flex", "min-h-10", "min-w-10", "items-center", "justify-center", "rounded-2xl", "border-4", "border-dashed", "border-base-400", "bg-base-300"], [1, "text-2xl", "text-base-100"], [1, "text-6xl"]], template: function SignageMediaListComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275conditionalCreate(18, SignageMediaListComponent_Conditional_18_Template, 5, 6, "div", 10);
    \u0275\u0275pipe(19, "async");
    \u0275\u0275conditionalBranchCreate(20, SignageMediaListComponent_Conditional_20_Template, 6, 3, "div", 11);
  }
  if (rf & 2) {
    let tmp_7_0;
    ...
    \u0275\u0275advance(3);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(6, 9, "COMMON.SEARCH"))("ngModel", ctx.search.getValue());
    \u0275\u0275advance(2);
    ...
    \u0275\u0275advance(5);
    \u0275\u0275conditional(((tmp_7_0 = \u0275\u0275pipeBind1(19, 15, ctx.media)) == null ? null : tmp_7_0.length) > 0 ? 18 : 20);
  }
}, dependencies: [DefaultValueAccessor, NgControlStatus, NgModel, MatFormField, MatInput, MatMenu, MatMenuItem, MatMenuTrigger, MatTooltip, MatRipple, IconComponent, CustomTooltipComponent, AuthenticatedImageDirective, CdkDropList, CdkDrag, CdkDragPlaceholder, AsyncPipe, TranslatePipe, MediaDurationPipe], styles: ["\n\n[_nghost-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  height: 100%;\n}\n/*# sourceMappingURL=signage-media-list.component.css.map */"] });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignageMediaListComponent, { className: "SignageMediaListComponent", filePath: "apps/concierge/src/app/signage/signage-media-list.component.ts", lineNumber: 306 });
})();

// apps/concierge/src/app/signage/signage-playlist-media-list.component.ts
function SignagePlaylistMediaListComponent_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 22);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275listener("click", function SignagePlaylistMediaListComponent_Conditional_5_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r2 = \u0275\u0275nextContext();
...
function SignagePlaylistMediaListComponent_Conditional_48_Template(rf, ctx) {
  if (rf & 1) {
...
function SignagePlaylistMediaListComponent_Conditional_69_Template(rf, ctx) {
  if (rf & 1) {
...
function SignagePlaylistMediaListComponent_Conditional_71_For_3_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 26);
  }
}
function SignagePlaylistMediaListComponent_Conditional_71_For_3_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 27);
  }
}
function SignagePlaylistMediaListComponent_Conditional_71_For_3_div_3_Template(rf, ctx) {
  if (rf & 1) {
...
function SignagePlaylistMediaListComponent_Conditional_71_For_3_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 25);
    \u0275\u0275conditionalCreate(1, SignagePlaylistMediaListComponent_Conditional_71_For_3_Conditional_1_Template, 1, 0, "div", 26)(2, SignagePlaylistMediaListComponent_Conditional_71_For_3_Conditional_2_Template, 1, 0, "div", 27);
    \u0275\u0275template(3, SignagePlaylistMediaListComponent_Conditional_71_For_3_div_3_Template, 3, 0, "div", 28);
    ...
    \u0275\u0275listener("click", function SignagePlaylistMediaListComponent_Conditional_71_For_3_Template_button_click_16_listener() {
    ...
    \u0275\u0275listener("click", function SignagePlaylistMediaListComponent_Conditional_71_For_3_Template_button_click_23_listener() {
      const item_r7 = \u0275\u0275restoreView(_r6).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275listener("click", function SignagePlaylistMediaListComponent_Conditional_71_For_3_Template_button_click_30_listener() {
      const item_r7 = \u0275\u0275restoreView(_r6).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
...
function SignagePlaylistMediaListComponent_Conditional_71_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 24);
    \u0275\u0275pipe(1, "async");
    \u0275\u0275listener("cdkDropListDropped", function SignagePlaylistMediaListComponent_Conditional_71_Template_div_cdkDropListDropped_0_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.drop($event));
    });
    \u0275\u0275repeaterCreate(2, SignagePlaylistMediaListComponent_Conditional_71_For_3_Template, 37, 13, "div", 25, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275pipe(4, "async");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function SignagePlaylistMediaListComponent_Conditional_73_Template(rf, ctx) {
  if (rf & 1) {
...
var _SignagePlaylistMediaListComponent = class _SignagePlaylistMediaListComponent {
  constructor() {
    ...
    this._playlist_media = this.selected_playlist.pipe(filter((playlist) => !!playlist), debounceTime(300), switchMap((playlist) => na(playlist.id).pipe(catchError(() => of({ id: "", items: [] })))), tap((_) => this.approved.set(_.approved)), shareReplay(1));
    this.media = combineLatest([
...
_SignagePlaylistMediaListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignagePlaylistMediaListComponent, selectors: [["signage-playlist-media-list"]], inputs: { playlist: [1, "playlist"], playlist_count: [1, "playlist_count"] }, standalone: false, features: [\u0275\u0275NgOnChangesFeature], decls: 74, vars: 69, consts: [["menu", "matMenu"], [1, "relative", "flex", "h-full", "w-full", "flex-col", "space-y-4", "p-4"], [1, "text-center", "text-xl", "font-medium"], ["icon", "", "matRipple", "", 1, "absolute", "left-2", "top-2", "!m-0", 3, "disabled", "matTooltip"], ["icon", "", "matRipple", "", 1, "absolute", "right-2", "top-2", "!m-0", 3, "matMenuTriggerFor"], ["mat-menu-item", "", 3, "click"], [1, "flex", "items-center", "space-x-2"], [1, "text-2xl"], [1, "pr-2"], ["mat-menu-item", "", 3, "click", "disabled"], [1, "text-2xl", "text-error"], ["details", "", 1, "flex", "flex-wrap", "items-center"], [1, "m-1", "ml-2", "rounded", "px-2", "py-1", "text-xs"], [1, "m-1", "ml-2", "rounded", "bg-secondary", "px-2", "py-1", "text-xs", "text-secondary-content"], ["matTooltip", "Default Transition Animation", 1, "m-1", "rounded", "bg-base-200", "px-2", "py-2", "text-xs"], [1, "ml-1", "rounded", "bg-base-300", "px-2", "py-1", "uppercase"], ["matTooltip", "Default Playback Duration", 1, "m-1", "rounded", "bg-base-200", "px-2", "py-2", "text-xs"], [1, "ml-1", "rounded", "bg-base-300", "px-2", "py-1", "font-mono"], ["matTooltip", "Prefered Orientation", 1, "m-1", "rounded", "bg-base-200", "px-2", "py-2", "text-xs"], [1, "m-1", "rounded", "bg-base-200", "px-2", "py-2", "text-xs", "uppercase"], ["cdkDropList", "", "id", "playlist-list", 1, "flex", "h-1/2", "flex-1", "flex-col", "space-y-2", "overflow-auto", 3, "cdkDropListData", "cdkDropListConnectedTo"], [1, "mx-auto", "flex", "flex-1", "flex-col", "items-center", "justify-center", "space-y-2", "p-8", "opacity-30"], ["icon", "", "matRipple", "", 1, "absolute", "left-2", "top-2", "!m-0", 3, "click", "disabled", "matTooltip"], [1, "text-2xl", "text-warning"], ["cdkDropList", "", "id", "playlist-list", 1, "flex", "h-1/2", "flex-1", "flex-col", "space-y-2", "overflow-auto", 3, "cdkDropListDropped", "cdkDropListData", "cdkDropListConnectedTo"], ["cdkDrag", "", 1, "relative", "flex", "h-20", "w-full", "items-center", "space-x-2", "rounded-lg", "border", "border-base-300", "bg-base-100", "p-2"], [1, "absolute", "inset-0", "z-0", "rounded-lg", "bg-warning", "opacity-10"], [1, "absolute", "inset-0", "z-0", "rounded-lg", "bg-error", "opacity-10"], ["class", "flex min-h-10 min-w-10 items-center justify-center rounded-2xl border-4 border-dashed border-base-400 bg-base-300", 4, "cdkDragPlaceholder"], ["matRipple", "", "cdkDragHandle", "", "matTooltip", "Drag to reorder", 1, "!m-0", "flex", "h-full", "w-6", "items-center", "justify-center", "rounded", "hover:bg-base-200"], ["preview", "", 1, "h-16", "w-[4.5rem]", "overflow-hidden", "rounded-lg", "bg-base-200"], ["auth", "", 1, "h-full", "w-full", "object-contain", 3, "source"], [1, "w-1/2", "flex-1", "truncate", "text-base-content"], ["icon", "", "matRipple", "", "aria-label", "Media Actions", 3, "matMenuTriggerFor"], [1, "flex", "min-h-10", "min-w-10", "items-center", "justify-center", "rounded-2xl", "border-4", "border-dashed", "border-base-400", "bg-base-300"], [1, "text-2xl", "text-base-100"], [1, "text-6xl"]], template: function SignagePlaylistMediaListComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(5, SignagePlaylistMediaListComponent_Conditional_5_Template, 4, 4, "button", 3);
    \u0275\u0275elementStart(6, "button", 4)(7, "icon");
    \u0275\u0275text(8, "more_vert");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "mat-menu", null, 0)(11, "button", 5);
    \u0275\u0275listener("click", function SignagePlaylistMediaListComponent_Template_button_click_11_listener() {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.editPlaylist());
    });
    \u0275\u0275elementStart(12, "div", 6)(13, "icon", 7);
    \u0275\u0275text(14, "edit");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function SignagePlaylistMediaListComponent_Template_button_click_18_listener() {
      \u0275\u0275restoreView(_r1);
      const playlist_r4 = \u0275\u0275readContextLet(1);
      return \u0275\u0275resetView(ctx.approvePlaylist(playlist_r4));
    });
    \u0275\u0275elementStart(19, "div", 6)(20, "icon", 7);
    \u0275\u0275text(21, "order_approve");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function SignagePlaylistMediaListComponent_Template_button_click_25_listener() {
      \u0275\u0275restoreView(_r1);
      const playlist_r4 = \u0275\u0275readContextLet(1);
      return \u0275\u0275resetView(ctx.copyID(playlist_r4 == null ? null : playlist_r4.id));
    });
    \u0275\u0275elementStart(26, "div", 6)(27, "icon", 7);
    ...
    \u0275\u0275pipe(31, "translate");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(32, "button", 5);
    \u0275\u0275listener("click", function SignagePlaylistMediaListComponent_Template_button_click_32_listener() {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.removePlaylist());
    });
    \u0275\u0275elementStart(33, "div", 6)(34, "icon", 10);
    \u0275\u0275text(35, "delete");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(47, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(48, SignagePlaylistMediaListComponent_Conditional_48_Template, 3, 3, "div", 13);
    \u0275\u0275pipe(49, "async");
    ...
    \u0275\u0275pipe(68, "async");
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(69, SignagePlaylistMediaListComponent_Conditional_69_Template, 3, 3, "div", 19);
    \u0275\u0275pipe(70, "async");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(71, SignagePlaylistMediaListComponent_Conditional_71_Template, 5, 6, "div", 20);
    \u0275\u0275pipe(72, "async");
    \u0275\u0275conditionalBranchCreate(73, SignagePlaylistMediaListComponent_Conditional_73_Template, 6, 3, "div", 21);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_10_0;
    ...
    \u0275\u0275advance();
    const playlist_r10 = \u0275\u0275storeLet(\u0275\u0275pipeBind1(2, 26, ctx.selected_playlist));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" Playlist - ", playlist_r10 == null ? null : playlist_r10.name, " ");
    \u0275\u0275advance();
    \u0275\u0275conditional(!ctx.approved() ? 5 : -1);
    \u0275\u0275advance();
    \u0275\u0275property("matMenuTriggerFor", menu_r9);
    \u0275\u0275advance(10);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(17, 29, "APP.CONCIERGE.SIGNAGE_PLAYLISTS_EDIT"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("disabled", ctx.approved() || !ctx.is_admin);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(24, 31, "APP.CONCIERGE.SIGNAGE_PLAYLISTS_APPROVE"), " ");
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(31, 33, "APP.CONCIERGE.SIGNAGE_PLAYLISTS_COPY_ID"), " ");
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(38, 35, "APP.CONCIERGE.SIGNAGE_PLAYLISTS_REMOVE"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275classProp("bg-success", (tmp_10_0 = \u0275\u0275pipeBind1(41, 37, ctx.selected_playlist)) == null ? null : tmp_10_0.enabled)("text-success-content", (tmp_11_0 = \u0275\u0275pipeBind1(42, 39, ctx.selected_playlist)) == null ? null : tmp_11_0.enabled)("bg-error", !((tmp_12_0 = \u0275\u0275pipeBind1(43, 41, ctx.selected_playlist)) == null ? null : tmp_12_0.enabled))("text-error-content", !((tmp_13_0 = \u0275\u0275pipeBind1(44, 43, ctx.selected_playlist)) == null ? null : tmp_13_0.enabled));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(47, 47, ((tmp_14_0 = \u0275\u0275pipeBind1(46, 45, ctx.selected_playlist)) == null ? null : tmp_14_0.enabled) ? "COMMON.ENABLED" : "COMMON.DISABLED"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275conditional(((tmp_15_0 = \u0275\u0275pipeBind1(49, 49, ctx.selected_playlist)) == null ? null : tmp_15_0.random) ? 48 : -1);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(52, 51, "APP.CONCIERGE.SIGNAGE_ANIMATION"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx.animation_name((tmp_17_0 = \u0275\u0275pipeBind1(55, 53, ctx.selected_playlist)) == null ? null : tmp_17_0.default_animation));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(58, 55, "APP.CONCIERGE.SIGNAGE_DURATION"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(62, 59, ((tmp_19_0 = \u0275\u0275pipeBind1(61, 57, ctx.selected_playlist)) == null ? null : tmp_19_0.default_duration) / 1e3));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(65, 61, "APP.CONCIERGE.SIGNAGE_ORIENTATION"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate((tmp_21_0 = \u0275\u0275pipeBind1(68, 63, ctx.selected_playlist)) == null ? null : tmp_21_0.orientation);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx.isScheduled(\u0275\u0275pipeBind1(70, 65, ctx.selected_playlist)) ? 69 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(\u0275\u0275pipeBind1(72, 67, ctx.media).length > 0 ? 71 : 73);
  }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignagePlaylistMediaListComponent, { className: "SignagePlaylistMediaListComponent", filePath: "apps/concierge/src/app/signage/signage-playlist-media-list.component.ts", lineNumber: 319 });
})();
...
var _SignageMediaComponent = class _SignageMediaComponent extends AsyncHandler {
  ...
  async drop(playlist, event) {
    ...
    const media_list = await na(playlist.id).toPromise();
...
_SignageMediaComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignageMediaComponent, selectors: [["signage-media"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 20, vars: 24, consts: [[1, "relative", "flex", "h-full", "w-full", "space-x-4", "overflow-visible"], ["sidebar", "", 1, "flex", "h-full", "w-64", "flex-col", "space-y-4", "overflow-auto", "py-4"], [1, "text-center", "text-xl", "font-medium"], ["appearance", "outline", 1, "no-subscript", "w-full"], ["matInput", "", 3, "ngModelChange", "placeholder", "ngModel"], ["matRipple", "", 1, "flex", "min-h-12", "w-full", "items-center", "rounded-3xl", "px-6", "hover:bg-base-200", 3, "routerLink", "queryParams"], [1, "w-full"], [1, "relative", "h-full", "w-1/2", "flex-1", "overflow-hidden", "rounded-lg", "border", "border-base-300", "shadow", 3, "dragover", "dragenter", "drop"], [1, "h-full", "w-full", "overflow-auto"], [3, "playlist_count"], [3, "playlist", "playlist_count"], [1, "absolute", "inset-0"], ["matRipple", "", "cdkDropList", "", 1, "flex", "h-12", "min-h-12", "w-full", "items-center", "rounded-3xl", "px-6", "hover:bg-base-200", 3, "!bg-secondary", "text-secondary-content", "routerLink", "queryParams", "id", "cdkDropListConnectedTo"], ["matRipple", "", "cdkDropList", "", 1, "flex", "h-12", "min-h-12", "w-full", "items-center", "rounded-3xl", "px-6", "hover:bg-base-200", 3, "cdkDropListDropped", "routerLink", "queryParams", "id", "cdkDropListConnectedTo"], [1, "flex-1"], [1, "flex", "flex-col", "items-center", "justify-center", "space-y-2", "p-8", "opacity-30"], [1, "text-6xl"], [1, "text-center"], ["btn", "", "matRipple", "", 1, "inverse"], ["btn", "", "matRipple", "", 1, "inverse", 3, "click"], [1, "flex", "w-full", "items-center", "justify-center"], [1, "text-2xl"], [1, "ml-2", "mr-4"], [1, "absolute", "inset-0", 3, "dragleave", "drop"], [1, "absolute", "inset-0", "bg-base-content", "opacity-60"], [1, "absolute", "inset-4", "flex", "flex-col", "items-center", "justify-center", "space-y-4", "rounded-2xl", "border-4", "border-dashed", "border-base-300", "text-base-100"], ["type", "file", 1, "absolute", "inset-0", "opacity-0", 3, "change"]], template: function SignageMediaComponent_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(22, _c07))("queryParams", \u0275\u0275pureFunction0(23, _c15));
    \u0275\u0275advance();
...
function SignageZonesComponent_Conditional_8_For_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(10, _c08))("queryParams", \u0275\u0275pureFunction1(11, _c16, zone_r2.id));
    \u0275\u0275advance();
...
function SignageZonesComponent_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, SignageZonesComponent_Conditional_8_For_2_Template, 4, 13, null, null, _forTrack06);
    \u0275\u0275pipe(3, "async");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
_SignageComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignageComponent, selectors: [["", "app-new-staff", ""]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], attrs: _c09, decls: 16, vars: 5, consts: [["tabPanel", ""], [1, "flex", "h-px", "flex-1"], [1, "flex", "h-full", "w-1/2", "flex-1", "flex-col"], [1, "flex", "h-28", "items-center", "justify-between", "p-8"], [1, "text-2xl", "font-medium"], ["btn", "", "matRipple", "", 1, "w-40"], [1, "px-8"], ["mat-tab-nav-bar", "", 3, "tabPanel"], ["mat-tab-link", "", 3, "routerLink", "active"], [1, "h-1/2", "flex-1", "overflow-auto", "px-8", "py-4"], ["btn", "", "matRipple", "", 1, "w-40", 3, "click"], ["mat-tab-link", "", 3, "click", "routerLink", "active"]], template: function SignageComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(11, SignageComponent_For_12_Template, 3, 5, "a", 8, _forTrack07);
    \u0275\u0275elementEnd()();
...
//# sourceMappingURL=signage.module-MFIJCXQX.js.map
