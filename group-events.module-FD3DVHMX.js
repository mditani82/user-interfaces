...
var _GroupEventsStateService = class _GroupEventsStateService {
  constructor() {
    ...
    this.calendar_system = this._org.active_building.pipe(debounceTime(100), switchMap((bld) => !bld ? of(null) : sc({ in: this.calendar }).pipe(map((r) => r.data?.[0]), catchError(() => of(null)))), shareReplay(1));
...
//# sourceMappingURL=group-events.module-FD3DVHMX.js.map
