...
var _DealsService = class _DealsService {
  constructor() {
    ...
    this.deals$ = combineLatest([
      ...
      return fu(bld.id, "deals-n-offers").pipe(catchError(() => of({ details: [] })));
...
}, dependencies: [TopbarComponent, FooterMenuComponent, MatMenu, MatMenuItem, MatMenuTrigger, MatRipple, IconComponent, AuthenticatedImageDirective, AsyncPipe, DatePipe, TranslatePipe], encapsulation: 2 });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DealsComponent, { className: "DealsComponent", filePath: "apps/workplace/src/app/deals/deals.component.ts", lineNumber: 180 });
})();
...
//# sourceMappingURL=deals.module-6GIQNYGC.js.map
