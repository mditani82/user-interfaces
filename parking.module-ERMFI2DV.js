...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ParkingBookingsListComponent, { className: "ParkingBookingsListComponent", filePath: "apps/concierge/src/app/parking/parking-bookings-list.component.ts", lineNumber: 226 });
})();
...
function ParkingTopbarComponent_Conditional_13_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(12, _c04))("matTooltip", \u0275\u0275pipeBind1(2, 8, "COMMON.LIST"));
    \u0275\u0275advance(4);
    \u0275\u0275classProp("inverse", ctx_r1.view() !== "map");
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(13, _c13))("matTooltip", \u0275\u0275pipeBind1(6, 10, "COMMON.MAP"));
  }
}
...
}, dependencies: [DateOptionsComponent, SearchbarComponent, MatFormField, MatSelect, MatOption, MatTooltip, MatRipple, NgControlStatus, NgModel, IconComponent, RouterLink, AsyncPipe, DecimalPipe, TranslatePipe, BuildingPipe], styles: ["\n\nbutton[_ngcontent-%COMP%] {\n  min-width: 0;\n  padding: 0 0.85rem;\n}\nmat-form-field[_ngcontent-%COMP%] {\n  height: 3.25em;\n  width: 8em;\n}\n/*# sourceMappingURL=parking-topbar.component.css.map */"] });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ParkingTopbarComponent, { className: "ParkingTopbarComponent", filePath: "apps/concierge/src/app/parking/parking-topbar.component.ts", lineNumber: 198 });
})();
...
_ParkingComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ParkingComponent, selectors: [["app-parking"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 11, vars: 4, consts: [["tabPanel", ""], [1, "flex", "h-px", "flex-1"], [1, "relative", "flex", "h-full", "w-1/2", "flex-1", "flex-col"], [1, "px-8", "pb-2"], [1, "relative", "h-1/2", "w-full", "flex-1", "overflow-auto", "px-8"], [1, "h-full", "w-full", "overflow-auto"], [1, "absolute", "inset-0", "z-50", "flex", "flex-col", "items-center", "justify-center"], ["mat-tab-nav-bar", "", 1, "overflow-hidden", "rounded", "bg-base-200", 3, "tabPanel"], ["mat-tab-link", "", 3, "routerLink", "active"], [1, "absolute", "inset-0", "z-0", "bg-base-100", "opacity-80"], [1, "z-10", "opacity-60"]], template: function ParkingComponent_Template(rf, ctx) {
  if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ParkingComponent, { className: "ParkingComponent", filePath: "apps/concierge/src/app/parking/parking.component.ts", lineNumber: 116 });
})();
...
//# sourceMappingURL=parking.module-ERMFI2DV.js.map
