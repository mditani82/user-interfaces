...
function getCateringRulesForZone(zone_id, fresh = false) {
  ...
  if (!RULE_REQUESTS[zone_id] || fresh)
    RULE_REQUESTS[zone_id] = fu(zone_id, "catering_config").pipe(map((_) => _.details instanceof Array ? _.details : []), catchError((e) => of([])));
...
var _CateringStateService = class _CateringStateService extends AsyncHandler {
  ...
  updateMenu(zone_id, menu) {
    return lastValueFrom(hu(zone_id, {
      id: zone_id,
      name: "catering",
      details: menu,
  ...
  async saveSettings(settings) {
    ...
    const result = await lastValueFrom(hu(this._org.building.id, {
  ...
  async getCateringForZone(zone_id) {
    const menu = (await fu(zone_id, "catering").toPromise()).details;
    return menu instanceof Array ? menu : [];
  }
  async getCateringConfig(zone_id = this._org.building.id) {
    const rules = (await fu(zone_id, "catering_config").toPromise()).details;
...
var _NewCateringSelectModalComponent = class _NewCateringSelectModalComponent {
  get favorites() {
    return this._settings.get(FAV_KEY) || EMPTY_FAVS2;
  }
  get selected_ids() {
    return this.selected.map((_) => _.custom_id).join(",");
  }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NewCateringSelectModalComponent, { className: "NewCateringSelectModalComponent", filePath: "libs/catering/src/lib/new-catering-order-modal/new-catering-select-modal.component.ts", lineNumber: 148 });
})();
...
var _BookCodeFlowComponent = class _BookCodeFlowComponent extends AsyncHandler {
  ...
  async _checkinEvent(space_id, email) {
    ...
    if (item) {
      ...
      const space = await lastValueFrom(uc(space_id));
      if (space) {
  ...
  _scanFrame() {
    const video_el = this._video_el()?.nativeElement;
    if (!video_el || this.loading())
      return;
    if (video_el.videoWidth === 0 || video_el.videoHeight === 0)
      return;
...
function NewDeskFormDetailsComponent_Conditional_0_Conditional_35_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275property("date", ctx_r1.form().getRawValue().date)("ngModel", ctx_r1.form().value)("ngModelOptions", \u0275\u0275pureFunction0(8, _c014))("available_days", ctx_r1.available_days);
    \u0275\u0275advance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NewDeskFlowFormComponent, { className: "NewDeskFlowFormComponent", filePath: "apps/workplace/src/app/book/desk-flow/desk-flow-form.component.ts", lineNumber: 58 });
})();

// apps/workplace/src/app/book/desk-flow/desk-flow-success.component.ts
var _c015 = (a0) => ({ name: a0 });
var _c19 = () => ["/"];
var _c26 = (a0, a1, a2, a3) => ({ date: a0, time: a1, size: a2, location: a3 });
...
_NewDeskFlowSuccessComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NewDeskFlowSuccessComponent, selectors: [["desk-flow-success"]], standalone: false, features: [\u0275\u0275ProvidersFeature([LevelPipe, BuildingPipe])], decls: 14, vars: 15, consts: [[1, "absolute", "inset-0", "z-50", "flex", "flex-col", "overflow-auto", "bg-base-100"], [1, "flex", "flex-1", "flex-col", "items-center", "justify-center", "space-y-2", "p-8"], [1, "text-center", "text-2xl", "font-medium"], ["src", "assets/icons/success.svg"], [1, "max-w-[40rem]", "text-center"], ["assets", ""], [1, "relative", "flex", "flex-col", "items-center", "space-y-4", "p-4"], [1, "sticky", "bottom-0", "mt-4", "flex", "w-full", "items-center", "justify-center", "border-t", "border-base-200", "bg-base-100", "p-2"], ["btn", "", "name", "desk-confirm-continue", "matRipple", "", 1, "mx-auto", "w-full", "max-w-[32rem]", 3, "routerLink"], ["btn", "", "matRipple", "", "name", "desk-outlook-link", "target", "_blank", "rel", "noopener noreferer", 1, "inverse", "flex", "w-64", "items-center", "space-x-2", "rounded", "p-2", "pr-4", 3, "href"], ["src", "assets/icons/outlook.svg", 1, "w-6"], ["btn", "", "matRipple", "", "name", "desk-google-link", "target", "_blank", "rel", "noopener noreferer", 1, "inverse", "flex", "w-64", "items-center", "space-x-2", "rounded", "p-2", "pr-4", 3, "href"], ["src", "assets/icons/gcal.svg", 1, "w-6"], ["btn", "", "matRipple", "", "name", "desk-ical-link", "target", "_blank", "rel", "noopener noreferer", 1, "inverse", "flex", "w-64", "items-center", "space-x-2", "rounded", "p-2", "pr-4", 3, "href"], [1, "text-xl"]], template: function NewDeskFlowSuccessComponent_Template(rf, ctx) {
  ...
  if (rf & 2) {
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(4, 7, "BOOKINGS.ITEM_BOOKED", \u0275\u0275pureFunction1(12, _c015, ctx.last_event.asset_name || ctx.last_event.asset_id)), " ");
    \u0275\u0275advance(3);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(NewDeskFlowSuccessComponent, [{
    ...
    `, providers: [LevelPipe, BuildingPipe], standalone: false }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NewDeskFlowSuccessComponent, { className: "NewDeskFlowSuccessComponent", filePath: "apps/workplace/src/app/book/desk-flow/desk-flow-success.component.ts", lineNumber: 164 });
})();
...
function MeetingFormDetailsComponent_Conditional_0_Conditional_18_mat_option_8_Template(rf, ctx) {
  if (rf & 1) {
...
function MeetingFormDetailsComponent_Conditional_0_Conditional_18_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(8, MeetingFormDetailsComponent_Conditional_0_Conditional_18_mat_option_8_Template, 3, 4, "mat-option", 28);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275advance(6);
    \u0275\u0275property("ngForOf", ctx_r0.visibility_options);
  }
}
function MeetingFormDetailsComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(18, MeetingFormDetailsComponent_Conditional_0_Conditional_18_Template, 9, 4, "div", 8);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MeetingFormDetailsComponent, { className: "MeetingFormDetailsComponent", filePath: "apps/workplace/src/app/book/meeting-flow/meeting-form-details.component.ts", lineNumber: 234 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MeetingFlowSuccessComponent, { className: "MeetingFlowSuccessComponent", filePath: "apps/workplace/src/app/book/meeting-flow/meeting-flow-success.component.ts", lineNumber: 100 });
})();
...
qr/esm/decode.js:
  ...
  *)
*/
//# sourceMappingURL=book.module-NL66NPKL.js.map
