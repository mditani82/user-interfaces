...
var _POIModalComponent = class _POIModalComponent extends AsyncHandler {
  ...
  async save() {
    ...
    this.loading = true;
    const old_metadata = await fu(this._org.organisation.id, "points-of-interest", {}).toPromise();
    ...
    const resp = await hu(this._org.organisation.id, {
...
_POIModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _POIModalComponent, selectors: [["poi-modal"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 44, vars: 43, consts: [[3, "confirm", "heading", "loading"], [3, "formGroup"], ["formControlName", "image", 1, "!mb-4", "block"], [1, "flex", "flex-col"], ["for", "location"], ["appearance", "outline"], ["placeholder", "Location Type", 3, "ngModelChange", "ngModel", "ngModelOptions"], ["value", "map_id"], ["value", "coordinates"], [1, "flex", "items-center", "space-x-2", "pb-2"], [1, "flex", "items-center", "space-x-2"], [1, "flex", "items-center", "space-x-4", "pt-2"], ["formControlName", "can_search", 1, "flex-1", 3, "name"], ["for", "media", 1, "mt-4"], [1, "flex", "items-center", "space-x-2", "pt-2"], ["appearance", "outline", 1, "no-subscript"], ["matInput", "", "formControlName", "media_url", 3, "placeholder"], [3, "ngModelChange", "ngModel", "ngModelOptions", "types"], ["for", "extra-details", 1, "mt-4"], [1, "space-y-2"], ["btn", "", "matRipple", "", 1, "mb-4", "mt-2", "w-full", 3, "click"], ["for", "name"], ["matInput", "", "name", "name", "formControlName", "name", 3, "placeholder"], ["for", "building"], ["placeholder", "Select Building", 3, "ngModelChange", "ngModel", "ngModelOptions"], [3, "value"], ["for", "level"], ["formControlName", "level_id", "placeholder", "Select Level"], ["matInput", "", "name", "location", "placeholder", "Location", "formControlName", "location"], ["icon", "", "matRipple", "", 1, "h-12", "w-12", "rounded", "border", "border-secondary", "text-secondary", 3, "click", "matTooltip"], ["appearance", "outline", 1, "flex-1"], ["matInput", "", "name", "latitude", 3, "ngModelChange", "ngModel", "ngModelOptions"], ["matInput", "", "name", "longitude", 3, "ngModelChange", "ngModel", "ngModelOptions"], ["matInput", "", "placeholder", "Label", 3, "ngModelChange", "ngModel", "ngModelOptions"], ["matInput", "", "placeholder", "Content", 3, "ngModelChange", "ngModel", "ngModelOptions"]], template: function POIModalComponent_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("ngModel", ctx.form.value.media_url)("ngModelOptions", \u0275\u0275pureFunction0(41, _c0))("types", \u0275\u0275pureFunction0(42, _c1));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(38, 38, "APP.CONCIERGE.POI_DETAILS"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275repeater(ctx.extra_details);
  }
}, dependencies: [\u0275NgNoValidate, DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, NgModel, MatFormField, MatInput, MatSelect, MatOption, MatTooltip, MatRipple, FormGroupDirective, FormControlName, ImageFieldComponent, IconComponent, SettingsToggleComponent, FullscreenModalShellComponent, UploadButtonComponent, AsyncPipe, TranslatePipe], encapsulation: 2 });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(POIModalComponent, { className: "POIModalComponent", filePath: "apps/concierge/src/app/poi-manager/poi-modal.component.ts", lineNumber: 257 });
})();
...
var _POIManagementService = class _POIManagementService {
  ...
  async removePointOfInterest(poi) {
    ...
    await hu(this._org.organisation.id, {
      name: "points-of-interest",
      details: metadata,
      description: ""
    }).toPromise().catch((e) => {
...
function POIListComponent_ng_template_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(26, "div", 16)(27, "icon");
    \u0275\u0275text(28, "preview");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementStart(33, "div", 17)(34, "icon", 18);
    \u0275\u0275text(35, "delete");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(2, 9, "APP.CONCIERGE.POI_PRIVATE_QR"));
    \u0275\u0275advance(2);
    \u0275\u0275property("content", qr_menu_r7);
    \u0275\u0275advance(3);
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(7, 11, "APP.CONCIERGE.POI_PUBLIC_QR"));
    \u0275\u0275advance(2);
    \u0275\u0275property("disabled", !row_r4.short_link_id)("content", qr_menu_r7);
    \u0275\u0275advance(5);
    \u0275\u0275property("matMenuTriggerFor", menu_r8);
    \u0275\u0275advance(10);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(24, 13, "APP.CONCIERGE.POI_EDIT"));
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(31, 15, "APP.CONCIERGE.POI_PREVIEW"));
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(38, 17, "APP.CONCIERGE.POI_REMOVE"));
  }
}
...
_POIListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _POIListComponent, selectors: [["poi-list"]], standalone: false, decls: 13, vars: 29, consts: [["level_template", ""], ["bool_template", ""], ["action_template", ""], ["qr_menu", ""], ["menu", "matMenu"], [1, "absolute", "inset-0", "overflow-auto", "px-8"], ["empty_message", "No Points of Interest found.", 1, "block", "min-w-[48rem]", "text-sm", 3, "data", "columns", "sortable"], [1, "h-12", "w-full"], [1, "p-4"], [1, "mx-auto", "flex", "h-8", "w-8", "items-center", "justify-center", "rounded", "bg-success", "text-2xl", "text-success-content"], [1, "mx-auto", "flex", "w-full", "justify-end", "space-x-2", "px-4", "py-2"], [3, "matTooltip"], ["icon", "", "matRipple", "", "customTooltip", "", 3, "click", "content"], ["icon", "", "matRipple", "", "customTooltip", "", 3, "click", "disabled", "content"], ["btn", "", "icon", "", "matRipple", "", 3, "matMenuTriggerFor"], ["mat-menu-item", "", 3, "click"], [1, "flex", "items-center", "space-x-2"], [1, "text-red-500", "flex", "items-center", "space-x-2"], [1, "text-error"], [1, "rounded", "bg-base-100", "py-2", "shadow"], ["printable", "", 1, ""], ["target", "_blank", "ref", "noopener noreferrer", 1, "mx-4", "my-2", "block", "rounded-lg", "border", "border-base-200", "bg-base-100", "p-2", 3, "href"], [1, "w-48", 3, "src"], [1, "mx-4", "mt-2", "w-[calc(100%-2rem)]", "rounded", "bg-base-200", "p-2", "text-center", "font-mono", "text-sm"], ["btn", "", "matRipple", "", 1, "mx-4", "my-2", "w-[calc(100%-2rem)]", 3, "click"]], template: function POIListComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(6, "div", 7);
    \u0275\u0275elementEnd();
    \u0275\u0275template(7, POIListComponent_ng_template_7_Template, 3, 3, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(9, POIListComponent_ng_template_9_Template, 1, 1, "ng-template", null, 1, \u0275\u0275templateRefExtractor)(11, POIListComponent_ng_template_11_Template, 39, 19, "ng-template", null, 2, \u0275\u0275templateRefExtractor);
  }
  if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(POIListComponent, { className: "POIListComponent", filePath: "apps/concierge/src/app/poi-manager/poi-list.component.ts", lineNumber: 150 });
})();
...
//# sourceMappingURL=poi-manager.module-NUGMCUR5.js.map
