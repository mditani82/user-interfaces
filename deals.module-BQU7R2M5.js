...
var _DealsService = class _DealsService extends AsyncHandler {
  ...
  async saveDeal(deal) {
    const metadata = await lastValueFrom(fu(this._org.building.id, "deals-n-offers")).catch(() => null);
    ...
    deals.push(deal);
    await lastValueFrom(hu(this._org.building.id, {
      name: "deals-n-offers",
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DealsListComponent, { className: "DealsListComponent", filePath: "apps/concierge/src/app/deals/deals-list.component.ts", lineNumber: 340 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DealsManageComponent, { className: "DealsManageComponent", filePath: "apps/concierge/src/app/deals/deals-manage.component.ts", lineNumber: 195 });
})();
...
//# sourceMappingURL=deals.module-BQU7R2M5.js.map
