...
var _LandingStateService = class _LandingStateService extends AsyncHandler {
  constructor() {
    ...
    this._space_statuses = this._filtered_spaces.pipe(tap((_) => this.unsubWith("bind:")), switchMap((list) => combineLatest((list || []).map((_) => {
      const binding = Ea(_.id, "Bookings").variable("status");
    ...
    this.search_fn = (q) => this._settings.get("app.basic_user_search") || this._settings.get("app.colleagues_require_auth") !== false ? Tc({ q, authority_id: vt()?.id }).pipe(map(({ data }) => data.map((_) => new StaffUser(_)))) : searchStaff(q);
  ...
  async updateContacts() {
    const metadata = await lastValueFrom(fu(currentUser().id, "contacts"));
    const list = metadata.details instanceof Array ? metadata.details : [];
    const users = await Promise.all(list.map((_) => lastValueFrom(Pc(_.email).pipe(catchError(() => of(_))))));
  ...
  async addContact(user) {
    ...
    await lastValueFrom(hu(currentUser().id, {
      name: "contacts",
...
function LandingAvailabilityComponent_Conditional_3_For_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate((building_r2 == null ? null : building_r2.display_name) || (building_r2 == null ? null : building_r2.name));
  }
}
...
function LandingAvailabilityComponent_Conditional_5_For_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate((level_r6 == null ? null : level_r6.display_name) || (level_r6 == null ? null : level_r6.name));
  }
}
...
function LandingAvailabilityComponent_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 4);
    \u0275\u0275repeaterCreate(1, LandingAvailabilityComponent_Conditional_5_For_2_Template, 16, 9, "button", 15, \u0275\u0275componentInstance().trackBySpaceId, true);
    \u0275\u0275pipe(3, "async");
...
}, dependencies: [MatRipple, MatProgressSpinner, IconComponent, AuthenticatedImageDirective, RouterLink, AsyncPipe, TranslatePipe, LevelPipe, BuildingPipe, SpacePipe], styles: ["\n\n*[_ngcontent-%COMP%] {\n  flex-shrink: 0;\n}\n/*# sourceMappingURL=landing-availability.component.css.map */"] });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LandingAvailabilityComponent, { className: "LandingAvailabilityComponent", filePath: "apps/workplace/src/app/landing/landing-availability.component.ts", lineNumber: 173 });
})();
...
var _LandingFavouritesComponent = class _LandingFavouritesComponent extends AsyncHandler {
  ...
  async ngOnInit() {
    this._room_alerts = await lastValueFrom(fu(this._org.organisation.id, "room_alerts").pipe(map((v) => v.details)));
  }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LandingFavouritesComponent, { className: "LandingFavouritesComponent", filePath: "apps/workplace/src/app/landing/landing-favourites.component.ts", lineNumber: 277 });
})();
...
}, dependencies: [MatRipple, MatProgressSpinner, TranslatePipe], encapsulation: 2 });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LandingQuickBookComponent, { className: "LandingQuickBookComponent", filePath: "apps/workplace/src/app/landing/landing-quick-book.component.ts", lineNumber: 79 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LandingUpcomingComponent, { className: "LandingUpcomingComponent", filePath: "apps/workplace/src/app/landing/landing-upcoming.component.ts", lineNumber: 95 });
})();
...
}, dependencies: [TopbarComponent, FooterMenuComponent, MatRipple, IconComponent, LandingColleaguesComponent, LandingAvailabilityComponent, LandingUpcomingComponent, LandingFavouritesComponent, LandingQuickLinksComponent, LandingQuickBookComponent, DatePipe, TranslatePipe], styles: ["\n\n[_nghost-%COMP%] {\n  position: absolute;\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  overflow: hidden;\n  display: flex;\n  flex-direction: column;\n}\nmain[_ngcontent-%COMP%] {\n  min-height: 50%;\n}\n/*# sourceMappingURL=landing.component.css.map */"] });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LandingComponent, { className: "LandingComponent", filePath: "apps/workplace/src/app/landing/landing.component.ts", lineNumber: 131 });
})();
...
//# sourceMappingURL=landing.module-F6UF3NO7.js.map
